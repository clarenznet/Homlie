    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //if (strWelcome.equals("support")){
        ...
        try {
            ...
            strActivity = extras.getString("strActivity");
         //   strOrderIdEdit = extras.getString("strOrderId");

            //new LoadStoryMoreDetails().execute();
        }catch (NullPointerException f){
            ///////////////////
        }


        // Making not*(ification bar transparent

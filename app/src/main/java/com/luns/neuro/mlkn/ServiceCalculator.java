...
public class ServiceCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.deliveryrecycler_view);
...
//        recyclerView.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
        ...
        ///////////////////////////
        recycler_demographics = (RecyclerView) findViewById(R.id.recycler_demographics);
...
//        });
        ...
        btn_uploadOrder= (Button) findViewById(R.id.btn_uploadOrder);
        ...
        edtSelectedTime = (EditText) findViewById(R.id.edtSelectedTime);
        ...
        edtSelectedDate=(EditText)findViewById(R.id.edtSelectedDate);
...
//////////////////////////////////////////////////////
    ...
    public void selectTime()
    {
        ...
        timepickerInit=(TimePicker)d.findViewById(R.id.timePickerInit);
        //Uncomment the below line of code for 24 hour view
        timepickerInit.setIs24HourView(true);
        edtSelectedTime.setText(getCurrentTime());
        Button btnDoneSelectTime=(Button)d.findViewById(R.id.btnDoneSelectTime);
    ...
    public void selectDate()
    {
        ...
        datePickerInit=(DatePicker)d.findViewById(R.id.datePickerInit);
        edtSelectedDate.setText(getCurrentDate());
        Button btnDoneSelectDate=(Button)d.findViewById(R.id.btnDoneSelectDate);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            if(volleyError instanceof TimeoutError ||volleyError instanceof NoConnectionError){
                                ...
                                //
                                Toast.makeText(ServiceCalculator.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
...
//        CardViewDataAdapterListener listener
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public NetworkImageView nimv_article_image;
            public EditText edtQuantity;
            public Button btnSub,btnAdd;
            public ViewHolder(View itemLayoutView) {
                super(itemLayoutView);
                tv_articlename = (TextView) itemLayoutView.findViewById(R.id.tv_articlename);
                tv_articleprice = (TextView) itemLayoutView.findViewById(R.id.tv_articleprice);
                tv_articlecat = (TextView) itemLayoutView.findViewById(R.id.tv_articlecat);
                edtQuantity=(EditText)itemLayoutView.findViewById(R.id.edtdeliveryNoOfItem);
                nimv_article_image = (NetworkImageView) itemLayoutView.findViewById(R.id.nimv_article_image);
                btnSub=(Button) itemLayoutView.findViewById(R.id.btnSub);
                btnAdd=(Button) itemLayoutView.findViewById(R.id.btnAdd);
            }
        }
...
//           });
       ...
       public class ViewHolder extends RecyclerView.ViewHolder {
           ...
           public ViewHolder(View itemLayoutView) {
               super(itemLayoutView);
               btnDemographics=(TextView) itemLayoutView.findViewById(R.id.btnDemographics);
           }
       }
